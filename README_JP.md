...
* [Apple eBook](https://itunes.apple.com/us/book/swift-programming-language/id881256329?mt=11) - Apple公式のeBook

### Style Guides
[back to top](#readme)

* [GitHub](https://github.com/github/swift-style-guide) - Github社によるSwiftのコーディング規約
* [Raywenderlich](https://github.com/raywenderlich/swift-style-guide) - Raywenderlichのコーディング規約
* [SlideShare (LinkedIn)](https://github.com/SlideShareInc/swift-style-guide) - LinkedIn社のコーディング規約
* [Swift-Best-Practices](https://github.com/schwa/Swift-Community-Best-Practices/) - Swiftのベストプラクティス

### Third party Guides
[back to top](#readme)

* [30 Days of Swift](https://github.com/allenwong/30DaysofSwift) - Swiftの30日間チュートリアル
* [99 Swift Problems](http://www.enekoalonso.com/projects/99-swift-problems/) - 99問のSwift問題集、アルゴリズムやデータ構造をSwiftで学ぶ
* [A better way to learn Swift](https://github.com/GoThinkster/swift) - よりよい方法でSwiftを学ぶ
* [Awesome Swift Education](https://github.com/hsavit1/Awesome-Swift-Education) - Swift言語の本質的なところを学べるリンク一覧
* [Developing iOS 8 Apps with Swift](https://itunes.apple.com/us/course/developing-ios-8-apps-swift/id961180099) - Paul Hegartyによるスタンフォード大のコース
* [Developing iOS 9 Apps with Swift](https://itunes.apple.com/us/course/developing-ios-9-apps-swift/id1104579961) - 上のiOS9バージョン
* [Hacking With Swift](https://www.hackingwithswift.com) - 30の実例を通してSwiftを学ぶサイト ([projects source code](https://github.com/twostraws/HackingWithSwift)).
* [Learn Swift](https://github.com/nettlep/learn-swift) - Playgroundを通してSwiftを学ぶ
* [Natasha the Robot](https://www.natashatherobot.com/) - Swift学習の週刊ニュース
